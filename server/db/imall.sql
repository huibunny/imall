...
-- ----------------------------
BEGIN;
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (36, 2057, '中花菜心 500g', '菜心', 5.00, 500, 'http://localhost:8401/image/IMG_0001.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 11:52:44', '2022-06-23 11:52:54');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (37, 2058, '有机上海青 300g', '上海青', 8.00, 330, 'http://localhost:8401/image/IMG_0002.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 11:56:18', '2022-06-23 11:56:31');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (39, 2061, '红心火龙果 200g', '火龙果', 13.00, 30, 'http://localhost:8401/image/IMG_0003.PNG', '图片仅供参考，请以实物为准', 0, 2, '2022-06-23 12:26:53', '2022-06-23 12:57:55');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (40, 2062, '安岳柠檬 120g', '柠檬', 3.00, 340, 'http://localhost:8401/image/IMG_0004.PNG', '图片仅供参考，请以实物为准', 0, 2, '2022-06-23 12:47:36', '2022-06-23 12:58:22');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (41, 2063, '南非冰糖小苹果 450g', '苹果', 10.00, 220, 'http://localhost:8401/image/IMG_0005.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 13:02:01', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (42, 2064, '香蕉 500g', '香蕉', 8.00, 450, 'http://localhost:8401/image/IMG_0006.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 13:05:19', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (43, 2065, '新疆香梨 400g', '香梨', 10.00, 23, 'http://localhost:8401/image/IMG_0007.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 13:34:35', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (44, 2066, '红西柚 500g', '红西柚', 7.00, 60, 'http://localhost:8401/image/IMG_0008.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 13:44:59', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (45, 2067, '麒麟瓜 5kg', '麒麟瓜', 32.00, 200, 'http://localhost:8401/image/IMG_0009.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 13:56:55', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (46, 2068, '黄甜瓜 600g', '甜瓜', 9.00, 350, 'http://localhost:8401/image/IMG_0010.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:08:37', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (47, 2069, '黄秋葵 250g', '黄秋葵', 5.00, 50, 'http://localhost:8401/image/IMG_0011.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:12:18', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (48, 2070, '胡萝卜 260g', '胡萝卜', 3.00, 105, 'http://localhost:8401/image/IMG_0012.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:14:45', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (49, 2071, '土豆 200g', '土豆', 2.00, 68, 'http://localhost:8401/image/IMG_0013.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:17:05', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (50, 2072, '黄羊河甜玉米 250g', '甜玉米', 8.00, 200, 'http://localhost:8401/image/IMG_0014.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:19:21', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (51, 2073, '海鲜菇 240g', '海鲜菇', 3.00, 30, 'http://localhost:8401/image/IMG_0015.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:21:49', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (52, 2074, '洋葱 200g', '洋葱', 4.00, 200, 'http://localhost:8401/image/IMG_0016.JPG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:24:11', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (53, 2075, '香菜 90g', '香菜', 3.00, 12, 'http://localhost:8401/image/IMG_0017.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:26:52', '');
INSERT INTO `goods` (`id`, `category_id`, `title`, `name`, `price`, `quantity`, `image_url`, `remark`, `sales`, `status`, `created`, `updated`) VALUES (54, 2076, '菜椒 300g', '菜椒', 4.00, 300, 'http://localhost:8401/image/IMG_0018.PNG', '图片仅供参考，请以实物为准', 0, 1, '2022-06-23 14:30:54', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `market` (`id`, `name`, `type`, `banner_image`, `begin_time`, `over_time`, `goods_ids`, `status`, `created`, `updated`) VALUES (11, '钻石展位1', 1, 'http://localhost:8401/image/b1.png', '2022-06-23 00:00:00', '2022-06-30 00:00:00', '42', 1, '2022-06-23 14:33:28', '2022-06-23 14:34:15');
INSERT INTO `market` (`id`, `name`, `type`, `banner_image`, `begin_time`, `over_time`, `goods_ids`, `status`, `created`, `updated`) VALUES (12, '钻石展位2', 1, 'http://localhost:8401/image/b2.png', '2022-06-23 00:00:00', '2022-06-30 00:00:00', '40', 1, '2022-06-23 14:34:11', '2022-06-23 14:34:16');
COMMIT;
